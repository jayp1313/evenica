...
export default function AwardsSection() {
  return (
    <section className="bg-gray-50 py-16 px-6 md:px-20" id="awards">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm md:text-base">
              ...
              recognizes partners that excel at providing innovative and unique
              customer solutions centered on Microsoft Dynamics 365 Commerce.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div>
            ...
            <p className="text-gray-700 text-sm md:text-base">
              ...
              award in 2020 for our rapid revenue growth, entrepreneurial spirit
              and bold innovation. The program recognizes technology companies
              with the highest revenue-growth percentage over the past four
              years. Evenica earned this recognition with 420% revenue growth
              from 2016 and 2019.
            </p>
          </div>
          <Image
